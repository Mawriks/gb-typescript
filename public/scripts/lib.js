...
export function getRemotenessByCoords(start, end) {
    ...
    const lat1 = start[0] * Math.PI / 180, lat2 = end[0] * Math.PI / 180, long1 = start[1] * Math.PI / 180, long2 = end[1] * Math.PI / 180, longDiff = long2 - long1;
...
function roundNumber(number, digits) {
    const multiple = Math.pow(10, digits), rndedNum = Math.round(number * multiple) / multiple;
    return rndedNum;
}
