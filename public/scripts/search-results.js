...
export function toggleFavoriteItem(data) {
    ...
    if (inFavorite(data)) {
        ...
        Object.assign(store, __assign({}, filtered));
    }
    else {
        Object.assign(store, __assign(__assign({}, items), (_a = {}, _a[Object.keys(items).length] = { id: data.id, name: data.name, image: data.image }, _a)));
    }
